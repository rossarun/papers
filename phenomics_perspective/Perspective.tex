...
integration at scale (e.g.,
\citep{mungall_integrating_2010, stucky_plant_2018}), enabling an
increasing scope beyond single taxon or single ecosystem models.
...
unstructured data that are available at scale. ML predictions often rely
on complex, ``black box'' methodologies to assess explanatory variables.
Here we introduce the GenoPhenoEnvo project, an effort to predict
phenotype from genetic and environmental data, while developing novel
representations of the ML ``black-box'' internals.
